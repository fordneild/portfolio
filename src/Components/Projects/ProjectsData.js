...
const memeHubShowcaseData = {
	...
	showcaseImage:
		"https://firebasestorage.googleapis.com/v0/b/portfolio-9117a.appspot.com/o/memehub%202.0.png?alt=media&token=26ed03bb-91b4-40b5-a955-a936d3a35f91",
	showcaseImageWidth: "620px",
};
...
const projectsData = [
	// memehub
	{
		...
		description: {
			Background:
				"I built MemeHub.io alongside a team of 5 engineers from JHU to aggregate memes from Instagram, Facebook, and Reddit and serve them in a personalized TikTok style feed. I solved a wide range of technical problems spanning data science, web development, and distributed systems.",
			What_I_Did: {
				bullet1:
	...
	// le chiffre
	{
		...
		description: {
			...
			What_I_Did: {
				...
				bullet4:
					"I created two React forms with unobtrusive user validation.",
				bullet5:
	...
	// Assembers and Disassembler
	{
		...
		category: academia,
		githubLink:
			"https://github.com/fordneild/SCRAM-assembler-and-simulator",
		description: {
			Background:
	...
	// binary semantic text analysis
	{
		...
		description: {
			...
			What_I_Did: {
				...
				bullet2:
					"The medium performed the best and achieved 85% accuracy.",
				bullet3:
